...
""")
    ...
    for ucode in ("ICTNWK421", "ICTNWK423"):
        ...
        mcq(
            ...
            ["Grant broad access initially and restrict permissions after incidents occur", "Give only the minimum access needed to do the job", "Ensure every user has the same level of access for consistency and fairness", "Assign permissions based on department seniority and job tenure"],
            1,
        ...
        mcq(
            ...
            ["Scan incoming files for malware signatures and quarantine threats", "Filter network traffic according to rules/policy", "Authenticate users before granting access to network resources", "Monitor network performance and optimise bandwidth allocation"],
            1,
        ...
        mcq(
            ...
            ["SSH supports more concurrent sessions than Telnet", "SSH encrypts the session; Telnet is plaintext", "SSH operates on a lower port number which improves security", "SSH uses compression by default while Telnet does not"],
            1,
        ...
        mcq(
            ...
            ["Confidentiality — preventing unauthorised reading of data", "Integrity checking — detecting whether data has been altered", "Authentication — verifying user identity during login", "Non-repudiation — proving who sent a message"],
            1,
        ...
        mcq(
            ...
            ["Daily full backups stored on an external drive", "Versioned backups / file history style versioning", "Incremental backups taken weekly to a network share", "RAID 1 mirroring across two drives in the same machine"],
            1,
        ...
        mcq(
            ...
            ["Detect suspicious activity and alert administrators", "Block malicious traffic inline and prevent attacks in real-time", "Filter traffic based on access control lists and firewall rules", "Scan endpoints for malware and quarantine infected files"],
            0,
        ...
        mcq(
            ...
            ["Require password changes every 7 days with no reuse restrictions", "Enforce minimum length + complexity + lockout policy", "Use a single strong shared password for each department", "Set maximum password length to 8 characters to reduce forgotten passwords"],
            1,
        ...
        if ucode == "ICTNWK421":
            mcq(
                ...
                ["It inspects application-layer payloads for malware signatures", "It tracks connection state and allows legitimate return traffic automatically", "It operates faster because it skips packet header inspection", "It uses deep packet inspection to decrypt and analyse encrypted traffic"],
                1,
            ...
            mcq(
                ...
                ["All traffic is allowed unless it matches a specific deny rule", "All traffic is blocked unless explicitly allowed by a rule", "All outbound traffic is blocked but inbound traffic is permitted", "All traffic from external sources is denied but internal traffic flows freely"],
                1,
            ...
            mcq(
                ...
                ["Application (Layer 7) — inspecting HTTP and FTP commands", "Network and Transport (Layers 3-4) — examining IP addresses and ports", "Data Link (Layer 2) — filtering based on MAC addresses", "Session (Layer 5) — managing connection dialogues between hosts"],
                1,
            ...
            mcq(
                ...
                ["Source and destination IP addresses in the packet header", "The actual content and payload of application protocols like HTTP", "TCP sequence numbers and window sizes for flow control", "VLAN tags and 802.1Q headers on trunk ports"],
                1,
            ...
            mcq(
                ...
                ["Allow individual remote workers to securely access corporate email", "Securely link two entire networks over the internet", "Encrypt traffic between a client device and a public Wi-Fi hotspot", "Create an isolated guest network within a single office location"],
                1,
            ...
            mcq(
                ...
                ["To permanently connect two branch office networks together", "To let a remote worker securely access the corporate network", "To create a secure link between two data centres for replication", "To segment internal network traffic between different VLANs"],
                1,
            ...
            mcq(
                ...
                ["Denial-of-service attacks flooding the VPN gateway", "Eavesdropping on data in transit", "Brute-force attacks against user passwords", "Unauthorised physical access to network devices"],
                1,
            ...
            mcq(
                ...
                ["Assign a single public IP to each private host", "Map multiple private hosts to a single public IP using different source ports", "Remove port information so traffic is anonymous", "Translate application-layer payloads to conform with policy"],
                1,
            ...
            mcq(
                ...
                ["It monitors throughput to throttle high bandwidth flows", "It remembers the handshake state so returning packets are allowed without extra rules", "It enforces per-user authentication on each packet", "It operates at Layer 2 which is faster than packet filters"],
                1,
            ...
            mcq(
                ...
                ["Block all ICMP and ARP traffic across VLANs", "Inspect and filter HTTP/FTP requests by validating headers and payload", "Replace IDS sensors because it prevents all intrusions", "Perform NAT for internal hosts only"],
                1,
            ...
            mcq(
                ...
                ["It prevents attackers from seeing the firewall status page", "It builds an audit trail to detect repeated attack patterns and tune rules", "It encrypts logs so the firewall can be remote managed", "It alerts the SIEM to automatically patch services"],
                1,
            ...
            mcq(
                ...
                ["Enable symmetric encryption on all RTP streams", "Allow the same UDP port through the firewall and map it via PAT", "Disable SIP ALG on the firewall and allow a range of UDP ports", "Only allow RTP on TCP port 443"],
                2,
            ...
            mcq(
                ...
                ["Trust every internal request but verify external ones", "Verify continuously and treat every request as potentially hostile", "Use a single perimeter firewall to protect the entire network", "Allow access based only on physical presence and device type"],
                1,
            ...
            mcq(
                ...
                ["Splitting the network into hardware VLANs with a single ACL per VLAN", "Using software-defined policies to restrict east-west traffic between workloads", "Allowing all internal traffic by default because it is low risk", "Routing all VLANs through one flat switch"],
                1,
            ...
            mcq(
                ...
                ["User awareness training", "Hypervisor, physical hosts, and the compute/storage infrastructure", "Application-level authentication for customer apps", "Data classification and backup strategy"],
                1,
            ...
            mcq(
                ...
                ["Allow executives to bypass MFA because they are trusted", "Disable email filters to let every message through for auditing", "Train staff to verify sender addresses and avoid clicking links from unknown sources", "Store passwords in spreadsheets so they can be shared quickly"],
                2,
            ...
            mcq(
                ...
                ["Documenting control weaknesses and mitigation suggestions", "Observing network traffic to understand topology", "Using a crafted payload to gain initial access", "Scheduling the assessment and scoping rules"],
                2,
            ...
            mcq(
                ...
                ["Scans simulate attacks while penetration tests simply run compliance scripts", "Scans identify potential weaknesses automatically; penetration tests attempt to exploit those weaknesses", "Penetration tests are automated while vulnerability scans always require human oversight", "Scans repair issues immediately after detection"],
                1,
            ...
            mcq(
                ...
                ["WireGuard requires per-user certificates managed manually", "WireGuard operates with fewer configuration options and a smaller codebase", "WireGuard encrypts only metadata while IPsec encrypts the entire packet", "WireGuard is only compatible with proprietary hardware"],
                1,
            ...
            mcq(
                ...
                ["The server sends its credential to the CA every 12 hours", "The server presents a certificate signed by a trusted CA and the client verifies it", "TLS skips authentication because the tunnel is already encrypted", "The server uses SHA-1 to hash the password and sends it in plaintext"],
                1,
            ...
            mcq(
                ...
                ["Connect IoT devices into the main VLAN with no filtering", "Segment IoT devices into a dedicated VLAN with strict ACLs and monitoring", "Disable logging to preserve limited device storage", "Allow remote management from the internet without firewall rules"],
                1,
            ...
            mcq(
                ...
                ["By encrypting traffic between VLAN members automatically", "By logically grouping hosts and restricting traffic between VLANs via ACLs", "By eliminating the need for firewalls since VLANs isolate traffic completely", "By broadcasting ARP responses to every VLAN"],
                1,
            ...
            mcq(
                ...
                ["To replace the need for IDS sensors", "To aggregate events, detect patterns, and correlate incidents", "To reduce log retention requirements", "To automatically patch systems without review"],
                1,
            ...
            mcq(
                ...
                ["Support compliance audits and incident investigations", "Ensure the firewall rule cache remains persistent", "Prevent attackers from reading the logs older than 90 days", "Allow production services to reuse the storage space quickly"],
                0,
            ...
            mcq(
                ...
                ["To eliminate the need for strong passwords altogether", "To combine two or more factors (knowledge, possession, inherence) for stronger assurance", "To rely solely on geolocation checks for authentication", "To allow password reuse across services"],
                1,
            ...
            mcq(
                ...
                ["Installing as many features as possible for flexibility", "Disabling unused services and ports to reduce the attack surface", "Escalating all users to local administrator rights to avoid permission issues", "Leaving default passwords because changing them may break scripts"],
                1,
            ...
            mcq(
                ...
                ["Applying patches only when users report issues", "Verifying vendor-supplied digital signatures before installing updates", "Installing every available update immediately without testing", "Maintaining a single monolithic update bundle for all systems"],
                1,
            ...
            mcq(
                ...
                ["To serve as primary business servers for high availability", "To distract attackers and collect forensic data on their methods", "To replace firewalls and simplify network architecture", "To host legally protected customer data"],
                1,
            ...
            mcq(
                ...
                ["Using a dedicated SIEM appliance on-premises", "Sending all traffic through a single small office router", "Deploying scrubbing services or anycast front-ends to absorb high-volume traffic", "Allowing unlimited concurrent connections on the firewall"],
                2,
            ...
            mcq(
                ...
                ["To block all outbound traffic", "To inspect HTTP payloads and block SQL injection/XSS before they reach the app", "To accelerate database queries", "To reduce the number of TLS certificates required"],
                1,
            ...
            mcq(
                ...
                ["It allows DNS responses only for internal resources", "It intercepts malicious DNS requests and redirects them to a safe server for logging", "It increases DNS response time dramatically", "It bypasses firewall rules for DNS traffic"],
                1,
            ...
            mcq(
                ...
                ["To allow them to connect to the internet without oversight", "To completely isolate critical systems (e.g., SCADA, backups) preventing network-based compromise", "To make updates easier by connecting them to all networks", "To reduce cooling requirements"],
                1,
            ...
            mcq(
                ...
                ["Single-factor pre-shared key", "RADIUS with device or user certificates", "Open authentication with no password", "MAC filtering alone"],
                1,
            ...
            mcq(
                ...
                ["Trust any SSID that matches corporate naming", "Use wireless monitoring tools to compare physical APs detected against inventory and location", "Rely solely on security policy for BYOD", "Allow all open networks so devices connect freely"],
                1,
            ...
            mcq(
                ...
                ["Set the same password on all routers for easy recovery", "Immediately change default usernames/passwords during commissioning", "Allow vendor defaults to remain for vendor support purposes", "Store default credentials in a shared spreadsheet offensive to interceptors"],
                1,
            ...
            mcq(
                ...
                ["Allow any personal device with no restrictions", "Enforce a mobile device management profile with enforced policies and containerisation", "Disable encryption on BYOD devices to simplify troubleshooting", "Share admin credentials across personal devices"],
                1,
            ...
            mcq(
                ...
                ["A legacy on-premises SIEM appliance", "Cloud Security Posture Management (CSPM) to monitor misconfigurations continuously", "Manual spreadsheet reviews done quarterly", "Turning off cloud logging to reduce costs"],
                1,
            ...
            mcq(
                ...
                ["Encrypting data at the application layer before it reaches the network stack", "Encapsulating private network packets inside public network packets", "Routing traffic through multiple proxy servers to hide the source IP", "Compressing packets to reduce bandwidth usage across the WAN link"],
                1,
            ...
            mcq(
                ...
                ["Keys allow multiple users to share the same login credentials securely", "Keys are much harder to brute-force and the private key never travels over the network", "Keys eliminate the need for encryption during the SSH session", "Keys automatically expire after 90 days, enforcing regular rotation"],
                1,
            ...
            mcq(
                ...
                ["An IDS sits inline and blocks traffic; an IPS monitors passively from a span port", "An IPS can block and prevent attacks inline; an IDS only detects and alerts", "An IDS uses signature-based detection while an IPS uses anomaly-based only", "An IPS operates at Layer 3 while an IDS operates at Layer 7 exclusively"],
                1,
            ...
            mcq(
                ...
                ["Inline between the firewall and the internet, filtering all traffic", "At a network tap or span port to monitor traffic passively", "On each server as a software agent monitoring local processes", "At the core switch replacing the default gateway for traffic analysis"],
                1,
            ...
            mcq(
                ...
                ["To provide a high-speed internal backbone connecting all VLANs", "To host public-facing services in an isolated zone between internal and external networks", "To create an encrypted tunnel for all external-facing traffic", "To segment the wireless network from the wired network within the LAN"],
                1,
            ...
            mcq(
                ...
                ["Server-side caching that improves page load times", "Encryption of data between browser and server via TLS", "Compression of web content to reduce bandwidth usage", "Authentication of the client's identity to the web server"],
                1,
            ...
            mcq(
                ...
                ["Overloading a DNS server with requests to cause a denial of service", "Inserting false DNS records so users are redirected to malicious sites", "Intercepting DNS queries to monitor which websites users visit", "Corrupting the DNS zone file by exploiting a buffer overflow on the server"],
                1,
            ...
            mcq(
                ...
                ["It exhausts the IP address pool, preventing legitimate devices from connecting", "It can hand out incorrect gateway/DNS settings, enabling man-in-the-middle attacks", "It assigns static IP addresses that conflict with existing reservations", "It broadcasts SSIDs that mimic the legitimate wireless network"],
                1,
            ...
            mcq(
                ...
                ["It analyses program behaviour at runtime to detect suspicious activity", "It compares files against a database of known malware signatures and patterns", "It uses machine learning to predict whether a file is likely malicious", "It sandboxes every executable in a virtual environment before allowing it to run"],
                1,
            ...
            mcq(
                ...
                ["To scan for known CVEs and produce an automated vulnerability report", "To simulate real attacks and find exploitable vulnerabilities before attackers do", "To verify that firewall rules match the organisation's security policy document", "To test backup and restore procedures under disaster recovery conditions"],
                1,
            ...
            mcq(
                ...
                ["Whether network bandwidth meets the agreed service level targets", "Who accessed what resources and whether access was authorised", "Whether all devices on the network have current antivirus signatures", "Whether firewall rules are optimised for maximum throughput"],
                1,
            ...
            mcq(
                ...
                ["An active attack that injects malicious packets into the data stream", "A passive attack that captures data without altering it", "An active attack that modifies data in transit between hosts", "A denial-of-service attack that disrupts network availability"],
                1,
            ...
            mcq(
                ...
                ["An attacker floods a server with traffic to deny service to legitimate users", "An attacker intercepts and potentially alters communication between two parties", "An attacker exploits a software vulnerability to gain root access to a server", "An attacker uses social engineering to trick a user into revealing credentials"],
                1,
            ...
            mcq(
                ...
                ["Two or more credentials from the same factor type, such as a password and a PIN", "Authentication from two or more different factor types (e.g. password + phone code)", "A single strong authentication method such as a long passphrase or biometric scan", "A password that is verified against two separate authentication servers for redundancy"],
                1,
            ...
            mcq(
                ...
                ["Deploying the strongest possible single security control at the network perimeter", "Layering multiple security controls so that if one fails, others still protect", "Focusing all security investment on the most likely threat vector identified in risk assessment", "Hardening every system to the highest security standard before deployment"],
                1,
            ...
            mcq(
                ...
                ["Syslog — centralised log collection from network devices", "SNMP — Simple Network Management Protocol for querying device status", "NetFlow — captures and analyses traffic flow data between hosts", "ICMP — used for ping and traceroute network diagnostics"],
                1,
            ...
            mcq(
                ...
                ["A log of all successful and failed login attempts to the device", "A set of rules that permit or deny traffic based on IP, port, or protocol", "A directory of user accounts and their assigned VLAN memberships", "A database of MAC addresses authorised to connect to switch ports"],
                1,
            ...
            mcq(
                ...
                ["Intercepting data in transit to read confidential information", "Deliberately altering data to deceive or cause harm", "Accidentally corrupting data due to a hardware failure or software bug", "Destroying data to prevent it from being recovered during an investigation"],
                1,
            ...
            mcq(
                ...
                ["WPA2/WPA3 use stronger encryption and key management than WEP, which is easily cracked", "WEP supports longer SSIDs and more channels than WPA2/WPA3", "WPA2/WPA3 operate only on the 5 GHz band, avoiding interference", "WEP is designed specifically for enterprise networks with RADIUS servers"],
                0,
            ...
            mcq(
                ...
                ["To automatically assign SSIDs based on device type", "To provide port-based network access control using EAP authentication", "To increase Wi‑Fi throughput by optimising channel bonding", "To enable mesh networking between access points"],
                1,
            ...
            mcq(
                ...
                ["An access point configured for guest access with a captive portal", "An unauthorised access point connected to the network, potentially bypassing security controls", "An access point that uses a hidden SSID to avoid detection", "An access point operating on a non-standard Wi‑Fi channel"],
                1,
            ...
            mcq(
                ...
                ["Open SSID with MAC filtering only", "WPA2/WPA3-Enterprise with 802.1X and unique credentials per user", "WEP with a long shared key rotated yearly", "Pre-shared WPA2 key shared among all staff and contractors"],
                1,
            ...
            mcq(
                ...
                ["Devices will not be able to obtain IP addresses from DHCP servers", "Any traffic not using its own encryption can be intercepted and read by anyone nearby", "The wireless signal cannot travel as far as with encryption enabled", "Access points will automatically reduce their transmit power"],
                1,
            ...
            mcq(
                ...
                ["They encrypt all traffic between switches by default", "They logically separate broadcast domains, limiting which devices can directly communicate", "They automatically block all inter-VLAN traffic", "They provide automatic redundancy if a switch fails"],
                1,
            ...
            mcq(
                ...
                ["By placing all devices, including servers and clients, into a single large VLAN", "By placing servers in a dedicated VLAN with firewall/ACL rules controlling which VLANs can talk to them", "By enabling spanning tree protocol on all switches", "By disabling DHCP on the server VLAN"],
                1,
            ...
            mcq(
                ...
                ["Broadcast storms cannot be controlled between VLANs", "All VLANs can communicate freely, reducing the benefit of segmentation", "Spanning tree will disable inter-VLAN links", "DHCP will not function correctly across VLANs"],
                1,
            ...
            mcq(
                ...
                ["To encrypt user passwords before they are stored in a database", "To bind a public key to an identity, allowing clients to verify they are talking to the correct server", "To compress web content before transmission", "To provide multi-factor authentication for VPN clients"],
                1,
            ...
            mcq(
                ...
                ["It may reduce page load performance and caching efficiency", "It could indicate a man-in-the-middle attack or misconfigured server, so continuing might expose credentials or data", "It will permanently block access to that website", "It means the website is using outdated HTML and CSS standards"],
                1,
            ...
            mcq(
                ...
                ["To reset a user's password after they forget it", "To mark a certificate as no longer trusted before its normal expiry date", "To extend the validity period of an expiring certificate", "To rotate symmetric encryption keys used by TLS"],
                1,
            ...
            mcq(
                ...
                ["Eradication – remove all malicious software from affected systems", "Containment – immediately disconnect all systems from the network", "Identification – confirm and classify the incident based on evidence", "Recovery – restore from backups to a known-good state"],
                2,
            ...
            mcq(
                ...
                ["Immediately wipe and rebuild all servers involved", "Isolate affected systems from the network while preserving evidence", "Silently ignore the incident to avoid alarming users", "Publicly disclose all details of the incident on social media"],
                1,
            ...
            mcq(
                ...
                ["To identify which staff should be blamed for the incident", "To improve controls, procedures, and training so similar incidents are less likely or less severe in future", "To reduce the need for audit logging", "To justify reducing the security budget if the incident was small"],
                1,
        ...
        if ucode == "ICTNWK423":
            ...
            mcq(
                ...
                ["A backup kept on the same storage as the production system", "A backup that cannot be altered or deleted once written", "A backup that automatically compresses duplicate files", "A backup that is stored only on tape and never restored"],
                1,
            ...
            mcq(
                ...
                ["To allow external auditors to inspect the backup media easily", "To keep a copy disconnected from networks so ransomware cannot reach it", "To reduce restore times by keeping data on local disk", "To avoid encrypting the backup data"],
                1,
            ...
            mcq(
                ...
                ["Rely solely on provider retention policies", "Implement a third-party SaaS backup that copies data to your own storage", "Use MFA for SaaS logins and nothing else", "Store data only locally and stop using SaaS"],
                1,
            ...
            mcq(
                ...
                ["Physical racks and hypervisor patches", "The guest OS, applications, data, and identity management", "Cooling, power distribution, and physical security", "Underground cabling routes between datacentres"],
                1,
            ...
            mcq(
                ...
                ["Only pricing for backup storage", "Risk description, likelihood, impact, and mitigation owner", "Daily user login counts", "Physical GPS coordinates of all devices"],
                1,
            ...
            mcq(
                ...
                ["Assigning a warranty to a new device", "Securely wiping or destroying data before retiring hardware", "Deploying the device into production VLANs", "Documenting physical locations for new assets"],
                1,
            ...
            mcq(
                ...
                ["Work directly on the original drive to save time", "Create an exact bit-for-bit copy and work on the copy", "Only capture artefacts from volatile memory", "Share evidence copies with anyone interested"],
                1,
            ...
            mcq(
                ...
                ["Which firewall rules should be updated next quarter", "The criticality of processes and the impact of downtime on operations", "Password policy complexity requirements", "The number of backup copies needed for compliance"],
                1,
            ...
            mcq(
                ...
                ["It mandates SaaS vendors skip encryption for local data", "It ensures personal information stays within legal jurisdictions and complies with APPs", "It allows vendors to store data anywhere without restriction", "It replaces the need for risk assessments"],
                1,
            ...
            mcq(
                ...
                ["Within 30 days", "Immediately, once feasible", "When the annual report is published", "Only when the customer asks"],
                1,
            ...
            mcq(
                ...
                ["TLS encrypts data during HTTPS sessions", "EFS encrypts files stored on a disk so stolen drives remain unreadable", "VPN encrypts traffic between remote workers", "Email encryption using S/MIME"],
                1,
            ...
            mcq(
                ...
                ["It blocks all outbound traffic regardless of content", "It inspects content and blocks or logs attempts to send sensitive keywords or files", "It encrypts all outbound emails by default", "It disables USB ports on all computers"],
                1,
            ...
            mcq(
                ...
                ["Enable the backup admin to log into the backup console with shared keys", "Ensure ransomware cannot encrypt or delete backups once written", "Compress backups aggressively to save storage", "Store backups on the same volume as production data"],
                1,
            ...
            mcq(
                ...
                ["RAID 6 writes data twice for faster writes", "RAID 6 uses dual parity, surviving two simultaneous disk failures", "RAID 6 uses striping with mirroring for better throughput", "RAID 6 requires fewer disks than RAID 5"],
                1,
            ...
            mcq(
                ...
                ["Uses less disk space than RAID 5", "Combines mirroring and striping for better performance and fault tolerance at the cost of capacity", "Relies only on parity so it can rebuild faster", "Does not require any controller to manage"],
                1,
            ...
            mcq(
                ...
                ["To keep data forever in case it is needed", "To define how long information is stored before it's securely destroyed", "To make backups more frequent", "To automatically encrypt data after 90 days"],
                1,
            ...
            mcq(
                ...
                ["Full backup every minute", "API-based exports that capture SaaS objects/data to customer storage", "Rely on provider replication alone", "Store everything in a spreadsheet on a shared drive"],
                1,
            ...
            mcq(
                ...
                ["To block users from accessing the tampered data", "To show who accessed or changed data and when", "To encrypt evidence before reporting", "To rotate backup tapes automatically"],
                1,
            ...
            mcq(
                ...
                ["DR plans focus on technology recovery; BC plans focus on keeping critical business functions running", "DR plans focus on marketing campaigns; BC plans focus on IT only", "They are identical and interchangeable", "BC plans only apply after the DR plan completes"],
                0,
            ...
            mcq(
                ...
                ["Keeping cables unorganised and close to the floor", "Placing equipment on raised racks and installing leak detectors", "Turning off environmental monitoring to reduce alarms", "Using only wireless networking gear"],
                1,
            ...
            mcq(
                ...
                ["It ensures every asset has identical configuration", "It tells you what must be protected, patched, monitored, or retired", "It allows you to ignore legacy devices", "It replaces the need for backups"],
                1,
            ...
            mcq(
                ...
                ["Leaving drives intact so they can be reassigned quickly", "Applying secure wipe or destruction so data cannot be recovered", "Selling retired devices with all data intact to save costs", "Ignorantly throwing away drives"],
                1,
            ...
            mcq(
                ...
                ["Just the final report with conclusions", "Chain of custody showing who handled the evidence and when", "Only the timestamp of the analysis", "Nothing, as long as the evidence is preserved"],
                1,
            ...
            mcq(
                ...
                ["By disabling backups to improve performance", "By implementing BCP/DR plans with people, processes, and technology steps to recover critical services", "By relying on a single backup tape stored locally without testing", "By writing passwords on sticky notes for easy access"],
                1,
            ...
            mcq(
                ...
                ["It ensures every file is encrypted regardless of content", "It ensures security controls match the sensitivity (e.g., public, official, secret)", "It replaces the need for backups", "It allows staff to delete data whenever they wish"],
                1,
            ...
            mcq(
                ...
                ["Using checksums to verify files after copying or restoration", "Backing up data without verifying restorability", "Deleting backup logs every 24 hours", "Allowing unrestricted write access to all staff"],
                0,
            ...
            mcq(
                ...
                ["Only files that have been modified since the last incremental backup", "A complete copy of all selected data at that point in time", "Only system state data including the registry and boot files", "Only data that differs from the current differential baseline"],
                1,
            ...
            mcq(
                ...
                ["All data that has changed since the last full backup only", "Only data that has changed since the last backup of any type", "A complete copy of all data, but compressed to reduce storage", "Only files that have been created new, excluding modified or deleted files"],
                1,
            ...
            mcq(
                ...
                ["It captures changes since the last full backup, not since the last backup of any type", "It captures only the changes since the most recent backup of any kind", "It creates a full copy each time but stores only the unique data blocks", "It backs up changes since the last incremental and merges them with the full"],
                0,
            ...
            mcq(
                ...
                ["A scheme using three full backups stored at three different offsite locations", "A scheme using daily (son), weekly (father), and monthly (grandfather) backup cycles", "A three-tier storage system: SSD for recent, HDD for medium-term, tape for archive", "A rotation using three backup servers that alternate as primary each week"],
                1,
            ...
            mcq(
                ...
                ["To ensure faster restore times by distributing data across multiple regions", "To protect against site-wide disasters like fire, flood, or theft", "To reduce the load on local storage systems during backup windows", "To comply with data sovereignty laws that require geographic distribution"],
                1,
            ...
            mcq(
                ...
                ["It identifies which files have changed and need to be included in the next backup", "It verifies that backups are usable and data can actually be recovered", "It compresses backup archives to reclaim storage space on the backup server", "It validates that the backup schedule aligns with the organisation's RPO targets"],
                1,
            ...
            mcq(
                ...
                ["The maximum acceptable downtime before services must be restored", "The maximum acceptable amount of data loss measured in time", "The minimum number of backup copies that must be retained at all times", "The target time to complete a full backup cycle of all systems"],
                1,
            ...
            mcq(
                ...
                ["The maximum tolerable amount of data loss measured in time", "The maximum acceptable downtime before services must be restored", "The frequency at which backups should be taken to meet recovery goals", "The total time required to complete a full backup of all systems"],
                1,
            ...
            mcq(
                ...
                ["RAID uses too much storage space compared to incremental backup strategies", "RAID protects against drive failure but not accidental deletion, corruption, ransomware, or site disasters", "RAID requires all disks to be the same brand and model, limiting flexibility", "RAID cannot be used alongside a backup solution due to I/O conflicts"],
                1,
            ...
            mcq(
                ...
                ["Stripes data with parity across three or more disks for fault tolerance", "Writes identical data to two or more disks for redundancy", "Stripes data across disks without parity for improved read/write performance", "Combines striping and mirroring using a minimum of four disks"],
                1,
            ...
            mcq(
                ...
                ["Full mirroring of data between pairs of disks in the array", "Distributed parity across all disks in the array", "A dedicated hot spare disk that automatically replaces any failed drive", "Striping without redundancy, relying on separate backups for data protection"],
                1,
            ...
            mcq(
                ...
                ["To encrypt data so it cannot be read by unauthorised parties", "To verify data has not been altered by comparing a computed value", "To compress data for more efficient storage and transmission", "To authenticate the identity of the sender of a message"],
                1,
            ...
            mcq(
                ...
                ["It encrypts sensitive data at rest to prevent unauthorised access", "It records who did what and when, supporting accountability and incident investigation", "It prevents users from making unauthorised changes by enforcing access controls", "It automatically restores data to its original state if corruption is detected"],
                1,
            ...
            mcq(
                ...
                ["To restrict all changes to production systems unless authorised by senior management alone", "To ensure changes are reviewed, approved, tested, and documented before implementation", "To automate the deployment of patches and updates without manual intervention", "To maintain a complete backup of every system state before and after each change"],
                1,
            ...
            mcq(
                ...
                ["Water damage from burst pipes or rising floodwater", "Fire destroying hardware and data in the server room", "Overheating caused by air conditioning failure", "Power surges from lightning strikes or grid instability"],
                1,
            ...
            mcq(
                ...
                ["Gas-based fire suppression systems like FM-200 or Novec 1230", "Raised flooring, water sensors, and locating equipment above ground level", "Uninterruptible power supplies (UPS) with surge protection", "Biometric access controls and CCTV monitoring at entry points"],
                1,
            ...
            mcq(
                ...
                ["Hardware failure caused by disk degradation over time", "Short-term power outages and surges, giving time for safe shutdown or generator start", "Overheating by providing supplemental cooling to server racks", "Flooding damage from burst pipes or rising water levels"],
                1,
            ...
            mcq(
                ...
                ["Low humidity causes static discharge that can damage sensitive components", "Overheating causes hardware failure and data loss; monitoring triggers alerts before damage occurs", "Cold temperatures slow down CPU processing and reduce server performance", "Temperature fluctuations indicate potential security breaches via the HVAC system"],
                1,
            ...
            mcq(
                ...
                ["How organisations must implement cybersecurity controls for critical infrastructure", "How organisations collect, use, store, and disclose personal information", "How personal data must be encrypted during storage and transmission", "How organisations report financial data to regulatory authorities"],
                1,
            ...
            mcq(
                ...
                ["A set of mandatory cybersecurity standards for all Australian businesses", "13 principles that outline how personal information must be handled under the Privacy Act", "A framework for classifying data sensitivity levels in government agencies", "Legally required data breach notification procedures for critical infrastructure"],
                1,
            ...
            mcq(
                ...
                ["The potential damage or consequence if a threat event occurs", "The probability that a threat will exploit a vulnerability", "The monetary value of the asset that is being protected from threats", "The number of known vulnerabilities currently present in the system"],
                1,
            ...
            mcq(
                ...
                ["Risk = Threat x Vulnerability x Asset Value", "Risk = Likelihood x Impact", "Risk = Impact divided by Likelihood", "Risk = Number of Vulnerabilities x Cost of Mitigation"],
                1,
            ...
            mcq(
                ...
                ["To identify and eliminate all potential threats before they cause disruption", "To define procedures for restoring IT systems and data after a major disruption", "To ensure the organisation can continue operations during a disruption without any downtime", "To document the organisation's risk appetite and acceptable levels of residual risk"],
                1,
            ...
            mcq(
                ...
                ["Applying a hotfix to resolve issues introduced by a recent change", "Reverting a system or data to a previous known-good state after a failed change", "Performing a full system restore from the most recent backup after data loss", "Gradually migrating services to new infrastructure while decommissioning the old"],
                1,
            ...
            mcq(
                ...
                ["Firewalls and intrusion detection systems monitoring network traffic", "Locked doors, key cards or biometrics, visitor logs, and CCTV", "Encryption of all data stored on servers within the room", "Role-based access control policies applied to network file shares"],
                1,
            ...
            mcq(
                ...
                ["To reduce storage costs by deleting older data", "To categorise data by sensitivity and impact so appropriate controls can be applied", "To ensure all data is kept forever for legal reasons", "To identify which files should be compressed for backup"],
                1,
            ...
            mcq(
                ...
                ["Sending it via unencrypted email to external addresses", "Storing it only on encrypted company devices and sharing via approved secure channels", "Copying it to personal USB drives for convenience", "Uploading it to any free cloud storage service for backup"],
                1,
            ...
            mcq(
                ...
                ["To automatically encrypt all data at rest", "To detect and prevent unauthorised transmission or storage of sensitive data", "To compress large files before they are emailed", "To track how much bandwidth users consume"],
                1,
            ...
            mcq(
                ...
                ["Blocking all attachments larger than 10 MB", "Scanning outbound emails for patterns like credit card or tax file numbers and blocking or encrypting them", "Deleting all emails older than 30 days", "Automatically adding a legal disclaimer to every message"],
                1,
            ...
            mcq(
                ...
                ["A BCP focuses only on IT systems; a DRP covers the whole business", "A BCP focuses on keeping critical business functions running; a DRP focuses on restoring IT systems and data", "A BCP is optional while a DRP is mandatory under all regulations", "A BCP is purely technical; a DRP is purely administrative"],
                1,
            ...
            mcq(
                ...
                ["The age of the hardware running each application", "The revenue, regulatory, and safety impact if a process is unavailable", "The number of users who have complained about the system in the past", "The vendor support contract expiry date"],
                1,
            ...
            mcq(
                ...
                ["Data is encrypted only while it is being transmitted over the network", "Data stored on disks or other media is encrypted, reducing impact if storage is lost or stolen", "Data is compressed before being written to disk to save space", "Data is digitally signed before transmission"],
                1,
            ...
            mcq(
                ...
                ["Encrypting backup media with strong algorithms", "Using checksums or hashes to verify backup files have not been altered or corrupted", "Storing backups in multiple geographic locations", "Compressing backups to reduce storage requirements"],
                1,
            ...
            mcq(
                ...
                ["The RPO is met because a daily full backup is always sufficient", "The RPO is not met; up to almost 24 hours of data could be lost if a failure occurs before the next backup", "The RPO is met if RAID is also used on the storage system", "The RPO does not apply to backup strategies, only to network availability"],
                1,
            ...
            mcq(
                ...
                ["A low RTO by allowing instant failover to a secondary site", "A 2‑hour RPO by limiting data loss to about 2 hours of changes", "A long-term retention requirement of 7 years", "A requirement for encryption at rest"],
                1,
            ...
            mcq(
                ...
                ["Audit logging and a documented change management process with rollback steps", "Periodic password changes and stricter screen lock settings", "Content filtering on the internet proxy and email gateway", "Increased Wi‑Fi coverage and bandwidth in the office"],
                0,
            ...
            mcq(
                ...
                ["Loss of confidentiality of backup data", "Unplanned outages and data integrity issues due to uncontrolled changes", "Increased spam volume entering user mailboxes", "Inability to restore from backups after a disaster"],
                1,
    ...
    if quiz_version_changed:
        cur.execute("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?);", ("quiz_seed_version", QUIZ_SEED_VERSION))
    ...
    for ucode in ("ICTNWK421", "ICTNWK423"):
        ...
        existing = cur.execute("SELECT COUNT(*) AS n FROM explain_topics WHERE unit_id = ?;", (unit_id,)).fetchone()["n"]
        if existing > 0:
            continue
